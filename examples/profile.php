          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center">Arch Mangaron</h3>
                  ...
                  <div class="tab-pane" id="settings">
                    <form action="profile_index.php" method="post" class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="Pnum" id="inputphonenumber" placeholder="Phone number">
                        </div>
                      </div>
                      <div class=" form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-check form-check-inline">
                          <input  type="radio" class="form-check-input" name="male" id="flexRadioGender">
                          <label class="form-check-label" for="flexRadioGender">
                            Male
                          </label>
                        </div>
                        <div class="form-check form-check-inline">
                          <input  type="radio" class="form-check-input" name="female" id="flexRadioGender">
                          <label class="form-check-label" for="flexRadioGender">
                            Female
                          </label>
                        </div>
                      ...
                      <div class=" form-group row">
                        ...
                        <div class="col-sm-15">
                          <input type="text" class="form-control" name="province" id="inputBirthday" placeholder="province">
                        </div>

                        <div class="col-sm-20">
                          <input type="text" class="form-control" name="city" id="inputBirthday" placeholder="city">
                        </div>

                        <div class="col-sm-25">
                          <input type="text" class="form-control" name="barangay" id="inputBirthday" placeholder="barangay">
                        </div>

                        <div class="col-sm-25">
                          <input type="text" class="form-control" name="zip_code" id="inputBirthday" placeholder="zip code">
                        </div>
